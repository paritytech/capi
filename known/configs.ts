...
export const rococo = new Config_("wss://rococo-contracts-rpc.polkadot.io", undefined! /* TODO */);
export const moonbeam = new Config_("wss://wss.api.moonbeam.network", 1284);
export const statemint = new Config_("wss://statemint-rpc.polkadot.io", undefined! /* TODO */);
