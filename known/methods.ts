...
export type TODO_NARROW_METHOD_TYPE = (...args: unknown[]) => unknown;

// TODO: attach type-level docs (draw from Substrate's source)
export type KnownRpcMethods = EnsureKnownMethods<{
  account: {
...
type EnsureKnownMethods<Lookup extends Record<string, rpc.AnyMethods>> = U.U2I<
  {
