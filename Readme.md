...
> Capi is a work in progress. The documentation may not reflect the current state of the implementation. **Expect a stable release and proper documentation in early 2023**.
