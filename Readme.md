...
```ts
import * as System from "http://localhost:8000/wss/rpc.polkadot.io/System.ts"
...
{
  "imports": {
    "#polkadot/": "http://localhost:8000/wss/rpc.polkadot.io/"
  }
}
```
...
```diff
- import * as System from "http://localhost:8000/wss/rpc.polkadot.io/System.ts"
+ import * as System from "#polkadot/System.ts"
