 ...
 * # </weight>
 */
export function transfer(value: Omit<types.pallet_balances.pallet.Call.transfer, "type">) {
 ...
 */
export function setBalance(value: Omit<types.pallet_balances.pallet.Call.setBalance, "type">) {
 ...
 *   #</weight>
 */
export function transferAll(value: Omit<types.pallet_balances.pallet.Call.transferAll, "type">) {
...
export const ExistentialDeposit: types.u128 = codecs.$6.decode(
 ...
 */
export const MaxLocks: types.u32 = codecs.$4.decode(C.hex.decode("32000000" as C.Hex))

/** The maximum number of named reserves that can exist on an account. */
export const MaxReserves: types.u32 = codecs.$4.decode(C.hex.decode("32000000" as C.Hex))
