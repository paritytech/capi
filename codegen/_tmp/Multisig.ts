...
export const Calls = new C.fluent.Storage(
  client,
  "Map",
  "Optional",
  "Multisig",
 ...
 * # </weight>
 */
export function asMulti(value: Omit<types.pallet_multisig.pallet.Call.asMulti, "type">) {
 ...
 */
export const DepositBase: types.u128 = codecs.$6.decode(
  C.hex.decode("008c61c52e0000000000000000000000" as C.Hex),
)
 ...
 */
export const DepositFactor: types.u128 = codecs.$6.decode(
  C.hex.decode("00d01213000000000000000000000000" as C.Hex),
)

/** The maximum amount of signatories allowed in the multisig. */
export const MaxSignatories: types.u16 = codecs.$81.decode(C.hex.decode("6400" as C.Hex))
