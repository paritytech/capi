 ...
 * # </weight>
 */
export function heartbeat(value: Omit<types.pallet_im_online.pallet.Call.heartbeat, "type">) {
 ...
 */
export const UnsignedPriority: types.u64 = codecs.$9.decode(
  C.hex.decode("ffffffffffffffff" as C.Hex),
)
