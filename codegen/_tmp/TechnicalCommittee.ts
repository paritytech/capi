 ...
 * # </weight>
 */
export function setMembers(value: Omit<types.pallet_collective.pallet.Call.setMembers, "type">) {
  return { type: "TechnicalCommittee", value: { ...value, type: "setMembers" } }
}
 ...
 * # </weight>
 */
export function execute(value: Omit<types.pallet_collective.pallet.Call.execute, "type">) {
 ...
 * # </weight>
 */
export function propose(value: Omit<types.pallet_collective.pallet.Call.propose, "type">) {
 ...
 * # </weight>
 */
export function vote(value: Omit<types.pallet_collective.pallet.Call.vote, "type">) {
 ...
 * # </weight>
 */
export function close(value: Omit<types.pallet_collective.pallet.Call.close, "type">) {
...
export function disapproveProposal(
  ...
  return { type: "TechnicalCommittee", value: { ...value, type: "disapproveProposal" } }
}
