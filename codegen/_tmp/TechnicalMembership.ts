 ...
 */
export function addMember(value: Omit<types.pallet_membership.pallet.Call.addMember, "type">) {
 ...
 */
export function swapMember(value: Omit<types.pallet_membership.pallet.Call.swapMember, "type">) {
 ...
 */
export function changeKey(value: Omit<types.pallet_membership.pallet.Call.changeKey, "type">) {
 ...
 */
export function setPrime(value: Omit<types.pallet_membership.pallet.Call.setPrime, "type">) {
