 ...
 * </weight>
 */
export function claim(value: Omit<types.polkadot_runtime_common.claims.pallet.Call.claim, "type">) {
...
export const Prefix: Uint8Array = codecs.$11.decode(
  C.hex.decode("8450617920444f547320746f2074686520506f6c6b61646f74206163636f756e743a" as C.Hex),
)
