...
export function send(value: Omit<types.pallet_xcm.pallet.Call.send, "type">) {
 ...
 *   fees.
 */
export function teleportAssets(value: Omit<types.pallet_xcm.pallet.Call.teleportAssets, "type">) {
 ...
 */
export function execute(value: Omit<types.pallet_xcm.pallet.Call.execute, "type">) {
 ...
 */
export function forceXcmVersion(value: Omit<types.pallet_xcm.pallet.Call.forceXcmVersion, "type">) {
