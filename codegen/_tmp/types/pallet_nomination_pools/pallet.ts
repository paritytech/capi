...
export const $call: $.Codec<types.pallet_nomination_pools.pallet.Call> = codecs.$369
...
export const $error: $.Codec<types.pallet_nomination_pools.pallet.Error> = codecs.$628
...
export const $event: $.Codec<types.pallet_nomination_pools.pallet.Event> = codecs.$91
