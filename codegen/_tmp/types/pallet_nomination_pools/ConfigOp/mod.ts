...
export const $$$u128: $.Codec<types.pallet_nomination_pools.ConfigOp.$$u128> = codecs.$371
export type $$u128 =
...
export const $$$u32: $.Codec<types.pallet_nomination_pools.ConfigOp.$$u32> = codecs.$372
export type $$u32 =
