...
export const $call: $.Codec<types.pallet_vesting.pallet.Call> = codecs.$251
...
export const $error: $.Codec<types.pallet_vesting.pallet.Error> = codecs.$561
...
export const $event: $.Codec<types.pallet_vesting.pallet.Event> = codecs.$76
