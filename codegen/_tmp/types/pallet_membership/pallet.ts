...
export const $call: $.Codec<types.pallet_membership.pallet.Call> = codecs.$242
...
export const $error: $.Codec<types.pallet_membership.pallet.Error> = codecs.$550
/** Custom [dispatch errors](https://docs.substrate.io/main-docs/build/events-errors/) of this pallet. */

export type Error = "AlreadyMember" | "NotMember" | "TooManyMembers"

export const $event: $.Codec<types.pallet_membership.pallet.Event> = codecs.$71
