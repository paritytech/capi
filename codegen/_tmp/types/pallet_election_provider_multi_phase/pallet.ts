...
export const $call: $.Codec<types.pallet_election_provider_multi_phase.pallet.Call> = codecs.$310
...
export const $error: $.Codec<types.pallet_election_provider_multi_phase.pallet.Error> = codecs.$607
...
export const $event: $.Codec<types.pallet_election_provider_multi_phase.pallet.Event> = codecs.$87
