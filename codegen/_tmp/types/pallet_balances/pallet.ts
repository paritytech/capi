...
export const $call: $.Codec<types.pallet_balances.pallet.Call> = codecs.$199
...
export const $error: $.Codec<types.pallet_balances.pallet.Error> = codecs.$475
...
export const $event: $.Codec<types.pallet_balances.pallet.Event> = codecs.$36
