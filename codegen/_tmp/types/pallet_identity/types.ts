...
export const $data: $.Codec<types.pallet_identity.types.Data> = codecs.$266
export type Data =
...
export const $identityField: $.Codec<types.pallet_identity.types.IdentityField> = codecs.$300
...
export const $identityInfo: $.Codec<types.pallet_identity.types.IdentityInfo> = codecs.$263
...
export const $judgement: $.Codec<types.pallet_identity.types.Judgement> = codecs.$301
...
export const $registrarInfo: $.Codec<types.pallet_identity.types.RegistrarInfo> = codecs.$571
...
export const $registration: $.Codec<types.pallet_identity.types.Registration> = codecs.$563
