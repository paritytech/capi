...
export const $call: $.Codec<types.frame_system.pallet.Call> = codecs.$161
...
export const $error: $.Codec<types.frame_system.pallet.Error> = codecs.$176
...
export const $event: $.Codec<types.frame_system.pallet.Event> = codecs.$19
...
export namespace Event {
  ...
  export interface ExtrinsicSuccess {
    ...
    dispatchInfo: types.frame_support.weights.DispatchInfo
  }
  /** An extrinsic failed. */
