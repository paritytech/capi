...
export const $call: $.Codec<types.polkadot_runtime_common.auctions.pallet.Call> = codecs.$412
...
export const $error: $.Codec<types.polkadot_runtime_common.auctions.pallet.Error> = codecs.$701
...
export const $event: $.Codec<types.polkadot_runtime_common.auctions.pallet.Event> = codecs.$118
