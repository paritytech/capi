...
export const $call: $.Codec<types.polkadot_runtime_common.crowdloan.pallet.Call> = codecs.$414
...
export const $error: $.Codec<types.polkadot_runtime_common.crowdloan.pallet.Error> = codecs.$704
...
export const $event: $.Codec<types.polkadot_runtime_common.crowdloan.pallet.Event> = codecs.$119
