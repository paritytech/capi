...
export const $call: $.Codec<types.pallet_multisig.pallet.Call> = codecs.$304
...
export const $error: $.Codec<types.pallet_multisig.pallet.Error> = codecs.$586
...
export const $event: $.Codec<types.pallet_multisig.pallet.Event> = codecs.$82
