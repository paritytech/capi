...
export const $assetId: $.Codec<types.xcm.v1.multiasset.AssetId> = codecs.$136
export type AssetId =
...
export const $assetInstance: $.Codec<types.xcm.v1.multiasset.AssetInstance> = codecs.$138
...
export const $fungibility: $.Codec<types.xcm.v1.multiasset.Fungibility> = codecs.$137
...
export const $multiAsset: $.Codec<types.xcm.v1.multiasset.MultiAsset> = codecs.$135
...
export const $multiAssetFilter: $.Codec<types.xcm.v1.multiasset.MultiAssetFilter> = codecs.$145
...
export const $multiAssets: $.Codec<types.xcm.v1.multiasset.MultiAssets> = codecs.$133
...
export const $wildFungibility: $.Codec<types.xcm.v1.multiasset.WildFungibility> = codecs.$147
export type WildFungibility = "Fungible" | "NonFungible"

export const $wildMultiAsset: $.Codec<types.xcm.v1.multiasset.WildMultiAsset> = codecs.$146
