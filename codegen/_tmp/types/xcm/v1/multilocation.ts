...
export const $junctions: $.Codec<types.xcm.v1.multilocation.Junctions> = codecs.$122
...
export const $multiLocation: $.Codec<types.xcm.v1.multilocation.MultiLocation> = codecs.$121
