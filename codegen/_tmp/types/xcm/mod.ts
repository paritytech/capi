...
export const $versionedMultiAssets: $.Codec<types.xcm.VersionedMultiAssets> = codecs.$150
...
export const $versionedMultiLocation: $.Codec<types.xcm.VersionedMultiLocation> = codecs.$155
...
export const $versionedResponse: $.Codec<types.xcm.VersionedResponse> = codecs.$708
...
export const $versionedXcm: $.Codec<types.xcm.VersionedXcm> = codecs.$434
