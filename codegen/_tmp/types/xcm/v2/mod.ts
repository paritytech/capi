...
export const $instruction: $.Codec<types.xcm.v2.Instruction> = codecs.$446
...
export const $response: $.Codec<types.xcm.v2.Response> = codecs.$140
...
export const $weightLimit: $.Codec<types.xcm.v2.WeightLimit> = codecs.$148
...
export const $xcm: $.Codec<types.xcm.v2.Xcm> = codecs.$444
