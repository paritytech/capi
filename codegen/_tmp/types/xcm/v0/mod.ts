...
export const $originKind: $.Codec<types.xcm.v0.OriginKind> = codecs.$143
export type OriginKind = "Native" | "SovereignAccount" | "Superuser" | "Xcm"

export const $response: $.Codec<types.xcm.v0.Response> = codecs.$428
...
export const $xcm: $.Codec<types.xcm.v0.Xcm> = codecs.$435
export type Xcm =
