...
export const $call: $.Codec<types.pallet_tips.pallet.Call> = codecs.$309
...
export const $error: $.Codec<types.pallet_tips.pallet.Error> = codecs.$595
...
export const $event: $.Codec<types.pallet_tips.pallet.Event> = codecs.$86
