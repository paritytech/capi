...
export const $call: $.Codec<types.pallet_elections_phragmen.pallet.Call> = codecs.$240
...
export const $error: $.Codec<types.pallet_elections_phragmen.pallet.Error> = codecs.$548
...
export const $event: $.Codec<types.pallet_elections_phragmen.pallet.Event> = codecs.$68
