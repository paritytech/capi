...
export const $renouncing: $.Codec<types.pallet_elections_phragmen.Renouncing> = codecs.$241
...
export const $seatHolder: $.Codec<types.pallet_elections_phragmen.SeatHolder> = codecs.$546
...
export const $voter: $.Codec<types.pallet_elections_phragmen.Voter> = codecs.$547
