...
export const $call: $.Codec<types.pallet_collective.pallet.Call> = codecs.$239
...
export namespace Call {
  ...
  export interface execute {
    type: "execute"
    proposal: types.polkadot_runtime.Call
  ...
  export interface close {
    ...
    index: types.Compact<types.u32>
    proposalWeightBound: types.Compact<types.frame_support.weights.weight_v2.Weight>
    lengthBound: types.Compact<types.u32>
  }
  /**
...
export const $error: $.Codec<types.pallet_collective.pallet.Error> = codecs.$544
...
export const $event: $.Codec<types.pallet_collective.pallet.Event> = codecs.$67
