...
export const $call: $.Codec<types.pallet_child_bounties.pallet.Call> = codecs.$308
...
export const $error: $.Codec<types.pallet_child_bounties.pallet.Error> = codecs.$593
/** Custom [dispatch errors](https://docs.substrate.io/main-docs/build/events-errors/) of this pallet. */

export type Error = "ParentBountyNotActive" | "InsufficientBountyBalance" | "TooManyChildBounties"

export const $event: $.Codec<types.pallet_child_bounties.pallet.Event> = codecs.$85
