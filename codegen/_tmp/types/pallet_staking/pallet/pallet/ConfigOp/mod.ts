...
export const $$$u128: $.Codec<types.pallet_staking.pallet.pallet.ConfigOp.$$u128> = codecs.$207
export type $$u128 =
...
export const $$$u32: $.Codec<types.pallet_staking.pallet.pallet.ConfigOp.$$u32> = codecs.$208
export type $$u32 =
