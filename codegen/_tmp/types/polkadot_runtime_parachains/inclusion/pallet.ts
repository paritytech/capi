...
export const $call: $.Codec<types.polkadot_runtime_parachains.inclusion.pallet.Call> = codecs.$376
/** Contains one variant per dispatchable that can be called by an extrinsic. */

export type Call = never

export const $error: $.Codec<types.polkadot_runtime_parachains.inclusion.pallet.Error> = codecs.$638
...
export const $event: $.Codec<types.polkadot_runtime_parachains.inclusion.pallet.Event> = codecs.$94
