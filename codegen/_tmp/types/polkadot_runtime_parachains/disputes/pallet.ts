...
export const $call: $.Codec<types.polkadot_runtime_parachains.disputes.pallet.Call> = codecs.$409
/** Contains one variant per dispatchable that can be called by an extrinsic. */

export type Call = "forceUnfreeze"

export const $error: $.Codec<types.polkadot_runtime_parachains.disputes.pallet.Error> = codecs.$692
...
export const $event: $.Codec<types.polkadot_runtime_parachains.disputes.pallet.Event> = codecs.$112
