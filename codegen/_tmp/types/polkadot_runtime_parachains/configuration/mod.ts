...
export const $hostConfiguration: $.Codec<
  types.polkadot_runtime_parachains.configuration.HostConfiguration
> = codecs.$630
export interface HostConfiguration {
  ...
  umpServiceTotalWeight: types.frame_support.weights.weight_v2.Weight
  ...
  umpMaxIndividualWeight: types.frame_support.weights.weight_v2.Weight
