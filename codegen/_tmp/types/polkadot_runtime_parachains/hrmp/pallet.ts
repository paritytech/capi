...
export const $call: $.Codec<types.polkadot_runtime_parachains.hrmp.pallet.Call> = codecs.$408
...
export const $error: $.Codec<types.polkadot_runtime_parachains.hrmp.pallet.Error> = codecs.$686
...
export const $event: $.Codec<types.polkadot_runtime_parachains.hrmp.pallet.Event> = codecs.$110
