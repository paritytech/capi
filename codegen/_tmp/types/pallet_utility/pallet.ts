...
export const $call: $.Codec<types.pallet_utility.pallet.Call> = codecs.$253
...
export namespace Call {
  ...
  export interface batch {
    type: "batch"
    calls: Array<types.polkadot_runtime.Call>
  }
  /**
...
export const $error: $.Codec<types.pallet_utility.pallet.Error> = codecs.$562
/** Custom [dispatch errors](https://docs.substrate.io/main-docs/build/events-errors/) of this pallet. */

export type Error = "TooManyCalls"

export const $event: $.Codec<types.pallet_utility.pallet.Event> = codecs.$77
