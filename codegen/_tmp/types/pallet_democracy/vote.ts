...
export const $accountVote: $.Codec<types.pallet_democracy.vote.AccountVote> = codecs.$64
...
export const $priorLock: $.Codec<types.pallet_democracy.vote.PriorLock> = codecs.$535
...
export const $vote: $.Codec<types.pallet_democracy.vote.Vote> = codecs.$65
...
export const $voting: $.Codec<types.pallet_democracy.vote.Voting> = codecs.$531
export type Voting =
