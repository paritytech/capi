...
export const $opaquePeerId: $.Codec<t.types.sp_core.OpaquePeerId> = _codec.$230

export const $void: $.Codec<t.types.sp_core.Void> = _codec.$262

export type OpaquePeerId = Uint8Array

export function OpaquePeerId(value: t.types.sp_core.OpaquePeerId) {
  return value
}
