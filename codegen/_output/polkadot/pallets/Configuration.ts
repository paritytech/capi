...
export function set_n_delay_tranches(
  value: Omit<t.polkadot_runtime_parachains.configuration.pallet.Call.set_n_delay_tranches, "type">,
): t.polkadot_runtime.RuntimeCall {
...
export function set_needed_approvals(
  value: Omit<t.polkadot_runtime_parachains.configuration.pallet.Call.set_needed_approvals, "type">,
): t.polkadot_runtime.RuntimeCall {
...
export function set_parathread_cores(
  value: Omit<t.polkadot_runtime_parachains.configuration.pallet.Call.set_parathread_cores, "type">,
): t.polkadot_runtime.RuntimeCall {
