...
export const $call: $.Codec<t.pallet_child_bounties.pallet.Call> = _codec.$308

export const $error: $.Codec<t.pallet_child_bounties.pallet.Error> = _codec.$597

export const $event: $.Codec<t.pallet_child_bounties.pallet.Event> = _codec.$84

/** Contains one variant per dispatchable that can be called by an extrinsic. */
export type Call =
  | t.pallet_child_bounties.pallet.Call.add_child_bounty
  | t.pallet_child_bounties.pallet.Call.propose_curator
  | t.pallet_child_bounties.pallet.Call.accept_curator
  | t.pallet_child_bounties.pallet.Call.unassign_curator
  | t.pallet_child_bounties.pallet.Call.award_child_bounty
  | t.pallet_child_bounties.pallet.Call.claim_child_bounty
  | t.pallet_child_bounties.pallet.Call.close_child_bounty
export namespace Call {
  ...
  export interface add_child_bounty {
    ...
    parent_bounty_id: t.Compact<t.u32>
  ...
  export interface propose_curator {
    ...
    parent_bounty_id: t.Compact<t.u32>
    child_bounty_id: t.Compact<t.u32>
...
export type Event =
  | t.pallet_child_bounties.pallet.Event.Added
  | t.pallet_child_bounties.pallet.Event.Awarded
  | t.pallet_child_bounties.pallet.Event.Claimed
  | t.pallet_child_bounties.pallet.Event.Canceled
export namespace Event {
  ...
  export function Added(
    value: Omit<t.pallet_child_bounties.pallet.Event.Added, "type">,
  ): t.pallet_child_bounties.pallet.Event.Added {
    return { type: "Added", ...value }
  }
  /** A child-bounty is awarded to a beneficiary. */
  export function Awarded(
    value: Omit<t.pallet_child_bounties.pallet.Event.Awarded, "type">,
  ): t.pallet_child_bounties.pallet.Event.Awarded {
    return { type: "Awarded", ...value }
  }
  /** A child-bounty is claimed by beneficiary. */
  export function Claimed(
    value: Omit<t.pallet_child_bounties.pallet.Event.Claimed, "type">,
  ): t.pallet_child_bounties.pallet.Event.Claimed {
    return { type: "Claimed", ...value }
  }
  /** A child-bounty is cancelled. */
  export function Canceled(
    value: Omit<t.pallet_child_bounties.pallet.Event.Canceled, "type">,
  ): t.pallet_child_bounties.pallet.Event.Canceled {
