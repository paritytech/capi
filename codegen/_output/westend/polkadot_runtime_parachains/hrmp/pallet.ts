...
export const $call: $.Codec<t.polkadot_runtime_parachains.hrmp.pallet.Call> = _codec.$409

export const $error: $.Codec<t.polkadot_runtime_parachains.hrmp.pallet.Error> = _codec.$694

export const $event: $.Codec<t.polkadot_runtime_parachains.hrmp.pallet.Event> = _codec.$111

/** Contains one variant per dispatchable that can be called by an extrinsic. */
export type Call =
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.hrmp_init_open_channel
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.hrmp_accept_open_channel
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.hrmp_close_channel
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.force_clean_hrmp
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.force_process_hrmp_open
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.force_process_hrmp_close
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.hrmp_cancel_open_request
  | t.polkadot_runtime_parachains.hrmp.pallet.Call.force_open_hrmp_channel
export namespace Call {
  ...
  export interface hrmp_init_open_channel {
    ...
    proposed_max_capacity: t.u32
    proposed_max_message_size: t.u32
  }
  /**
  ...
  export interface hrmp_close_channel {
    ...
    channel_id: t.polkadot_parachain.primitives.HrmpChannelId
  }
  /**
...
export type Event =
  | t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelRequested
  | t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelCanceled
  | t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelAccepted
  | t.polkadot_runtime_parachains.hrmp.pallet.Event.ChannelClosed
  | t.polkadot_runtime_parachains.hrmp.pallet.Event.HrmpChannelForceOpened
export namespace Event {
  ...
  export interface OpenChannelRequested {
    ...
    value: [t.polkadot_parachain.primitives.Id, t.polkadot_parachain.primitives.Id, t.u32, t.u32]
  }
  /**
  ...
  export interface OpenChannelCanceled {
    ...
    value: [t.polkadot_parachain.primitives.Id, t.polkadot_parachain.primitives.HrmpChannelId]
  }
  /** Open HRMP channel accepted. `[sender, recipient]` */
  export interface OpenChannelAccepted {
    type: "OpenChannelAccepted"
    value: [t.polkadot_parachain.primitives.Id, t.polkadot_parachain.primitives.Id]
  }
  ...
  export function OpenChannelRequested(
    ...value: t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelRequested["value"]
  ): t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelRequested {
  ...
  export function OpenChannelCanceled(
    ...value: t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelCanceled["value"]
  ): t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelCanceled {
    return { type: "OpenChannelCanceled", value }
  }
  /** Open HRMP channel accepted. `[sender, recipient]` */
  export function OpenChannelAccepted(
    ...value: t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelAccepted["value"]
  ): t.polkadot_runtime_parachains.hrmp.pallet.Event.OpenChannelAccepted {
    return { type: "OpenChannelAccepted", value }
  }
  /** HRMP channel closed. `[by_parachain, channel_id]` */
  export function ChannelClosed(
    ...value: t.polkadot_runtime_parachains.hrmp.pallet.Event.ChannelClosed["value"]
  ): t.polkadot_runtime_parachains.hrmp.pallet.Event.ChannelClosed {
  ...
  export function HrmpChannelForceOpened(
    ...value: t.polkadot_runtime_parachains.hrmp.pallet.Event.HrmpChannelForceOpened["value"]
  ): t.polkadot_runtime_parachains.hrmp.pallet.Event.HrmpChannelForceOpened {
