...
export const $call: $.Codec<t.types.frame_system.pallet.Call> = _codec.$161

export const $error: $.Codec<t.types.frame_system.pallet.Error> = _codec.$176

export const $event: $.Codec<t.types.frame_system.pallet.Event> = _codec.$20

/** Contains one variant per dispatchable that can be called by an extrinsic. */
export type Call =
  | t.types.frame_system.pallet.Call.fill_block
  | t.types.frame_system.pallet.Call.remark
  | t.types.frame_system.pallet.Call.set_heap_pages
  | t.types.frame_system.pallet.Call.set_code
  | t.types.frame_system.pallet.Call.set_code_without_checks
  | t.types.frame_system.pallet.Call.set_storage
  | t.types.frame_system.pallet.Call.kill_storage
  | t.types.frame_system.pallet.Call.kill_prefix
  | t.types.frame_system.pallet.Call.remark_with_event
export namespace Call {
  /** A dispatch that will fill the block weight up to the given ratio. */
  export interface fill_block {
    type: "fill_block"
    ratio: t.types.sp_arithmetic.per_things.Perbill
  }
  /**
...
export type Event =
  | t.types.frame_system.pallet.Event.ExtrinsicSuccess
  | t.types.frame_system.pallet.Event.ExtrinsicFailed
  | t.types.frame_system.pallet.Event.CodeUpdated
  | t.types.frame_system.pallet.Event.NewAccount
  | t.types.frame_system.pallet.Event.KilledAccount
  | t.types.frame_system.pallet.Event.Remarked
export namespace Event {
  /** An extrinsic completed successfully. */
  export interface ExtrinsicSuccess {
    type: "ExtrinsicSuccess"
    dispatch_info: t.types.frame_support.dispatch.DispatchInfo
  }
  /** An extrinsic failed. */
  export interface ExtrinsicFailed {
    type: "ExtrinsicFailed"
    dispatch_error: t.types.sp_runtime.DispatchError
    dispatch_info: t.types.frame_support.dispatch.DispatchInfo
  }
  /** `:code` was updated. */
  ...
  export interface Remarked {
    type: "Remarked"
    sender: t.types.sp_core.crypto.AccountId32
    hash: t.types.primitive_types.H256
  }
  /** An extrinsic completed successfully. */
  export function ExtrinsicSuccess(
    value: Omit<t.types.frame_system.pallet.Event.ExtrinsicSuccess, "type">,
  ): t.types.frame_system.pallet.Event.ExtrinsicSuccess {
    return { type: "ExtrinsicSuccess", ...value }
  }
  /** An extrinsic failed. */
  export function ExtrinsicFailed(
    value: Omit<t.types.frame_system.pallet.Event.ExtrinsicFailed, "type">,
  ): t.types.frame_system.pallet.Event.ExtrinsicFailed {
    return { type: "ExtrinsicFailed", ...value }
  }
  /** `:code` was updated. */
  export function CodeUpdated(): t.types.frame_system.pallet.Event.CodeUpdated {
    return { type: "CodeUpdated" }
  }
  /** A new account was created. */
  export function NewAccount(
    value: Omit<t.types.frame_system.pallet.Event.NewAccount, "type">,
  ): t.types.frame_system.pallet.Event.NewAccount {
    return { type: "NewAccount", ...value }
  }
  /** An account was reaped. */
  export function KilledAccount(
    value: Omit<t.types.frame_system.pallet.Event.KilledAccount, "type">,
  ): t.types.frame_system.pallet.Event.KilledAccount {
    return { type: "KilledAccount", ...value }
  }
  /** On on-chain remark happened. */
  export function Remarked(
    value: Omit<t.types.frame_system.pallet.Event.Remarked, "type">,
  ): t.types.frame_system.pallet.Event.Remarked {
