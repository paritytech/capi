...
export const $call: $.Codec<t.pallet_babe.pallet.Call> = _codec.$185

export const $error: $.Codec<t.pallet_babe.pallet.Error> = _codec.$467

/** Contains one variant per dispatchable that can be called by an extrinsic. */
export type Call =
  | t.pallet_babe.pallet.Call.report_equivocation
  | t.pallet_babe.pallet.Call.report_equivocation_unsigned
  | t.pallet_babe.pallet.Call.plan_config_change
export namespace Call {
  ...
  export interface report_equivocation {
    ...
    equivocation_proof: t.sp_consensus_slots.EquivocationProof
  ...
  export interface plan_config_change {
    ...
    config: t.sp_consensus_babe.digests.NextConfigDescriptor
  }
  /**
   * Report authority equivocation/misbehavior. This method will verify
   * the equivocation proof and validate the given key ownership proof
