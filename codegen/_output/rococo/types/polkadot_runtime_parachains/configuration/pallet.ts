...
export const $call: $.Codec<t.types.polkadot_runtime_parachains.configuration.pallet.Call> =
  _codec.$375

export const $error: $.Codec<t.types.polkadot_runtime_parachains.configuration.pallet.Error> =
  _codec.$641

/** Contains one variant per dispatchable that can be called by an extrinsic. */
export type Call =
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_validation_upgrade_cooldown
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_validation_upgrade_delay
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_code_retention_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_code_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_pov_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_head_data_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_parathread_cores
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_parathread_retries
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_group_rotation_frequency
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_chain_availability_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_thread_availability_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_scheduling_lookahead
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_validators_per_core
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_validators
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_dispute_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_dispute_post_conclusion_acceptance_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_dispute_max_spam_slots
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_dispute_conclusion_by_time_out_period
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_no_show_slots
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_n_delay_tranches
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_zeroth_delay_tranche_width
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_needed_approvals
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_relay_vrf_modulo_samples
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_upward_queue_count
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_upward_queue_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_downward_message_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_ump_service_total_weight
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_upward_message_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_max_upward_message_num_per_candidate
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_open_request_ttl
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_sender_deposit
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_recipient_deposit
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_channel_max_capacity
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_channel_max_total_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_max_parachain_inbound_channels
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_max_parathread_inbound_channels
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_channel_max_message_size
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_hrmp_max_parachain_outbound_channels
  ...
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_pvf_checking_enabled
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_pvf_voting_ttl
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_minimum_validation_upgrade_delay
  | t.types.polkadot_runtime_parachains.configuration.pallet.Call.set_bypass_consistency_check
export namespace Call {
  ...
  export interface set_ump_service_total_weight {
    ...
    new: t.types.sp_weights.weight_v2.Weight
  }
