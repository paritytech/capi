...
type MethodLookup = EnsureLookup<string, (...args: any[]) => any, {
  ...
  payment_queryInfo(extrinsic: U.Hex, hash?: U.HexHash): T.RuntimeDispatchInfo;
  ...
  state_queryStorageAt(keys: U.Hex[], at?: U.HexHash): T.StorageChangeSet;
  ...
  state_subscribeStorage(list: U.Hex[]): Subscription<"TODO">;
  ...
  chainHead_unstable_body(
    followSubscription: U.HexHash,
    networkConfig?: T.NetworkConfig,
  ): string;
  chainHead_unstable_call(
    hash: U.HexHash | undefined,
    fn: string,
  ...
  chainHead_unstable_storage(
    follow_subscription: SubscriptionId,
    hash: U.HexHash,
    key: U.Hex,
    childKey?: U.Hex,
    networkConfig?: T.NetworkConfig,
  ): string;
  chainHead_unstable_unfollow(followSubscription: SubscriptionId): void;
  chainHead_unstable_unpin(followSubscription: SubscriptionId, hash: U.HexHash): void;
  chainSpec_unstable_chainName(): string;
  chainSpec_unstable_genesisHash(): string;
  chainSpec_unstable_properties(): unknown;
  sudo_unstable_p2pDiscover(multiaddr: U.HexEncoded<P.MultiAddress>): void;
  sudo_unstable_version(): string;
  transaction_unstable_submitAndWatch(transaction: U.Hex): SubscriptionId;
  transaction_unstable_unwatch(subscription: SubscriptionId): void;
}>;
...
type SubscriptionId = U.Branded<string, typeof _N, Subscription>;
